...
from vistas import VistaCliente,VistaClientes,VistaTiposPersonas,VistaTipoPersona,\
                   VistaTipoDocumento,VistaTiposDocumentos,VistaActividadEconomica,\
                   VistaCategoriaEconomica,VistaDivisionEconomica
...
api.add_resource(VistaActividadEconomica,'/parametros/act_economica')
api.add_resource(VistaCategoriaEconomica,'/parametros/cat_economica')
api.add_resource(VistaDivisionEconomica,'/parametros/div_economica')
